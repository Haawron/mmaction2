...
class EvidenceLoss(BaseWeightedLoss):
    ...
    def _forward(self, output, target, domains=None, **kwargs):
        """Forward function.
        Args:
        ...
        if domains is not None:
            ...
            output = output[source_idx]
            target = target[source_idx]
        ...
        annealing_coef = self.compute_annealing_coef(**kwargs).to(output.device)
