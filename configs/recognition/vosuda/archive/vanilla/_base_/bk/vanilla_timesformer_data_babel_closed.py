...
ann_file_train = 'data/_filelists/babel/processed/filelist_babel_train_closed.txt'
ann_file_valid = 'data/_filelists/babel/processed/filelist_babel_val_closed.txt'
