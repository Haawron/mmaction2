_base_ = [
    ...
    '../__base__/closed_b2k_tsm_training.py',
...
pipelines = dict(
    source=dict(
        train=[
            dict(type='SampleFrames', clip_len=8, frame_interval=1, num_clips=8),
            dict(type='RawFrameDecode'),

            dict(type='Resize', scale=(-1, 256)),
            dict(type='RandomCrop', size=224),
            dict(type='Flip', flip_ratio=0.5),
            # dict(type='DebugInterPipelineVisualizer', namespace='clip_viz/b2k/k400', stop=4, ext='mp4'),
