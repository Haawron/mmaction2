    ...
    source=dict(
        train=dict(
            **datasets['K400'],
            ...
            ann_file='data/_filelists/k400/processed/debug/03_128.txt')),
    target=dict(
        train=dict(
            **datasets['BABEL'],
            data_prefix='/local_datasets/babel',
            ann_file='data/_filelists/babel/processed/debug/03_128.txt')))
...
pipelines = dict(
    ...
    target=dict(
        train=[
            ...
            dict(type='DebugInterPipelineVisualizer', namespace='cop/mp4', stop=1, ext='mp4'),
