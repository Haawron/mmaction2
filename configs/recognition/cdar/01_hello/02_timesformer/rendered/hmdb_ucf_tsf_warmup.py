_base_ = [
    # data
    '../../_base_/hello_training.py',
    '../../_base_/models/tsf_model.py',
...
dataset_settings = dict(
    ...
    target=dict(
        valid=dict(
            ...
            ann_file='data/_filelists/ucf101/filelist_ucf_test_merged_open_all.txt'),
        test=dict(
            type='RawframeDataset',
            data_prefix='/local_datasets/ucf101/rawframes',
            ann_file='data/_filelists/ucf101/filelist_ucf_train_open_all.txt')),
)
