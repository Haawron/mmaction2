...
ann_file_train_source = 'data/_filelists/hmdb51/processed/filelist_hmdb_train_closed.txt'
ann_file_train_target = 'data/_filelists/ucf101/processed/filelist_ucf_train_closed.txt'
