    ...
    source=dict(
        train=dict(
            **datasets['RawframeDataset'],
            ...
            ann_file='data/_filelists/ek100/processed/filelist_P02_train_closed.txt'),
        test=dict(
            **datasets['RawframeDataset'],
            test_mode=True,
            data_prefix=data_prefix,
    ...
    target=dict(
        valid=dict(
            **datasets['RawframeDataset'],
            test_mode=True,
            data_prefix=data_prefix,
            ann_file='data/_filelists/ek100/processed/filelist_P04_test_merged_open_all.txt'),
        test=dict(
            **datasets['RawframeDataset'],
            test_mode=True,
            data_prefix=data_prefix,
            ann_file='data/_filelists/ek100/processed/filelist_P04_train_open_all.txt')))
