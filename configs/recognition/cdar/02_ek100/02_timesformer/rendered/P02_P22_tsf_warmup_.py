    ...
    target=dict(
        valid=dict(
            **datasets['RawframeDataset'],
            test_mode=True,
            data_prefix=data_prefix,
            ann_file='data/_filelists/ek100/processed/filelist_P22_test_merged_open_all.txt'),
        test=dict(
            **datasets['RawframeDataset'],
            test_mode=True,
            data_prefix=data_prefix,
            ann_file='data/_filelists/ek100/processed/filelist_P22_train_open_all.txt')))
