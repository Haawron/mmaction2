...
ann_file_train_source = 'data/_filelists/ek100/mm-sada_resampled/hmdb51_train.txt'
ann_file_train_target = 'data/_filelists/ek100/mm-sada_resampled/ucf101_train.txt'
ann_file_val   = 'data/_filelists/ek100/mm-sada_resampled/ucf101_test.txt'
ann_file_test  = 'data/_filelists/ek100/mm-sada_resampled/ucf101_test.txt'
...
blend_options = dict(
    ...
    data_prefixes=[
        '/local_datasets/median/ek100-mm-sada-split/train/hmdb51',
        '/local_datasets/median/ek100-mm-sada-split/train/ucf101',
    ],
    blend_label=False
)
