...
#SBATCH -J vanilla-timesformer-babel-linear-probe-closed
#SBATCH -p batch
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-gpu=4
#SBATCH --mem-per-gpu=15G
#SBATCH -t 1-0
#SBATCH -x agi[1-2],augi1,vll[2-4]
#SBATCH --array 0-8%3
...
config=configs/recognition/hello/vanilla/vanilla_timesformer_babel_closed.py
workdir=work_dirs/train_output/babel2kinetics/timesformer/linear_probe/${name}/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
...
# 이 파일 closed, open template 화 시키기
