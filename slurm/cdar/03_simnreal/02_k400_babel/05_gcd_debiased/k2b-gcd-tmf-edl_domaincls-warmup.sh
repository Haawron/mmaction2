...
#SBATCH -J k2b-gcd-tmf-edl_domaincls-warmup
#SBATCH -p batch_vll
#SBATCH --gres=gpu:4
...
add_on='tmf'
extra_setting='edl_domaincls_warmup'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/02_k400_babel/05_gcd_debiased/k2b_gcd_tmf_edl_domaincls.py'
