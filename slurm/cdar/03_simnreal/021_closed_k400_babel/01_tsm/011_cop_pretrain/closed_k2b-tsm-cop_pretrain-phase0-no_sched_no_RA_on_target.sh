...
#SBATCH -J closed_k2b-tsm-cop_pretrain-phase0-no_sched_no_RA_on_target
#SBATCH -p batch
#SBATCH --gres=gpu:8
...
add_on='phase0'
extra_setting='no_sched'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/011_cop_pretrain/k2b_tsm_cop_pretrain_nosched_noRAontarget.py'
