...
#SBATCH -J closed_k2b-tsm-tmf-l2g1
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
backbone='01_tsm'
model='011_source_only_tmf'  # row
add_on='locality'
extra_setting='l2g1_45'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/010_source_only/temporal_locality/k2b_tsm_lngn_tmf.py'
