...
#SBATCH -J closed_k2b-tsm-target_only
#SBATCH -p batch
#SBATCH --gres=gpu:4
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/090_target_only/k2b_tsm.py'
