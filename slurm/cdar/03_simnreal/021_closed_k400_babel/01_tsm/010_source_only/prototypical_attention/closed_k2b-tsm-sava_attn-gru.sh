...
#SBATCH -J closed_k2b-tsm-sava_attn-gru
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
add_on='sava_attn'
extra_setting='gru'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/010_source_only/prototypical_attention/k2b_tsm_sava_attn.py'
