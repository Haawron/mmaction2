...
#SBATCH -J closed_k2b-tsm-tmf-all_bg_accumx2
#SBATCH -p batch
#SBATCH --gres=gpu:8
...
add_on='tmf'
extra_setting='all_bg'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/010_source_only/k2b_tsm_tmf_all_k400.py'
