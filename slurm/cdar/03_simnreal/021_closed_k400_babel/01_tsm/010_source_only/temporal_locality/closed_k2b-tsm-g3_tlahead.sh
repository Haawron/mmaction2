...
#SBATCH -J closed_k2b-tsm-g3_tlahead
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
add_on='locality'
extra_setting='g3_tlahead'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/010_source_only/temporal_locality/k2b_tsm_g3_tlahead.py'
