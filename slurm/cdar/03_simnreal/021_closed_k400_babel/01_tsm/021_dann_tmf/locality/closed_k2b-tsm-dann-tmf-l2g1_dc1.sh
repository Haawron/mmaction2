...
#SBATCH -J closed_k2b-tsm-dann-l2g1_dc1
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
add_on='locality'
extra_setting='l2g1_dc1'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/021_dann_tmf/temporal_locality/k2b_tsm_dann_tmf_lngn_dc1.py'
ckpts=(
