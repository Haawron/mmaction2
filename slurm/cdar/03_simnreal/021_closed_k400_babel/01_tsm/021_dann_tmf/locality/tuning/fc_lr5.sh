...
#SBATCH -J closed_k2b-tsm-dann-tmf-dc_glx+cop-fc_lr5
#SBATCH -p batch_grad
#SBATCH --gres=gpu:8
...
extra_setting='dc_glx+cop-fc_lr5'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/021_dann_tmf/temporal_locality/tuning/fc_lr5.py'
ckpts=(
