...
#SBATCH -J closed_k2b-tsm-dann-tmf-dc_glx+cop-interval4-50e
#SBATCH -p batch_grad
#SBATCH --gres=gpu:8
...
extra_setting='dc_glx+cop-interval4-50e'  # 'default' if none
...
OMP_NUM_THREADS=${N} MKL_NUM_THREADS=${N} torchrun --nproc_per_node="${N}" --master_port=$((10000+RANDOM%20000)) tools/train.py "$config" \
    ...
    --cfg-options \
        ...
        data.train.0.pipeline.0.frame_interval=4 total_epochs=50 \
