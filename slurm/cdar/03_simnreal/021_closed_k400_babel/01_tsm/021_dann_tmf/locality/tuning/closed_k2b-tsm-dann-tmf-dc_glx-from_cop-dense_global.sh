...
#SBATCH -J closed_k2b-tsm-dann-tmf-dc_glx-from_cop-dense_global
#SBATCH -p batch_grad
#SBATCH --gres=gpu:8
...
extra_setting='dc_glx+cop-from_cop-dense_global'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/021_dann_tmf/temporal_locality/k2b_tsm_dann_tmf_dc_glx.py'
ckpts=(
