...
#SBATCH -J closed_k2b-tsm-dann-tmf-l2g1_dc3
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/021_dann_tmf/temporal_locality/k2b_tsm_dann_tmf_lngn_dc3.py'
ckpts=(
