...
#SBATCH -J closed_k2b-tsm-dann_tmf-switch_accumx2
#SBATCH -p batch
#SBATCH --gres=gpu:4
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/021_dann_tmf/k2b_tsm_dann_tmf_only_source_switch_randaug.py'
