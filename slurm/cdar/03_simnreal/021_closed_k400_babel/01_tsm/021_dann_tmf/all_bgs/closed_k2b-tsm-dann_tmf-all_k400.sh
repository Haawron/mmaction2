...
#SBATCH -J closed_k2b-tsm-dann_tmf-all_k400
#SBATCH -p batch
#SBATCH --gres=gpu:4
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/021_dann_tmf/all_bgs/k2b_tsm_dann_tmf_all_k400.py'
