...
#SBATCH -J closed_k2b-tsm-dann_cop
#SBATCH -p batch
#SBATCH --gres=gpu:4
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/020_dann/k2b_tsm_dann.py'
ckpt='work_dirs/train_output/cdar/03_simnreal/021_closed_k400_babel/01_tsm/011_cop_pretrain/phase0/no_aug/37210__closed_k2b-tsm-cop_pretrain-phase0-no_sched_no_aug/0/20230413-194624/epoch_500.pth'  # not maturely trained
...
OMP_NUM_THREADS=${N} MKL_NUM_THREADS=${N} torchrun --nproc_per_node="${N}" --master_port=$((10000+RANDOM%20000)) tools/train.py "$config" \
    ...
    --work-dir "$workdir" \
    --cfg-options \
        load_from="$ckpt" optimizer.lr="$calibed_lr" \
        ckpt_revise_keys='' \
