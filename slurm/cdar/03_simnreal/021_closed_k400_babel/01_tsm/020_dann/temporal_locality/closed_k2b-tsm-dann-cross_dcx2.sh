...
#SBATCH -J closed_k2b-tsm-dann-cross_dcx2
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
model='020_dann'  # row
add_on='locality'
extra_setting='cross_dcx2'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/01_tsm/020_dann/temporal_locality/k2b_tsm_dann_cross_dcx2.py'
ckpts=(
