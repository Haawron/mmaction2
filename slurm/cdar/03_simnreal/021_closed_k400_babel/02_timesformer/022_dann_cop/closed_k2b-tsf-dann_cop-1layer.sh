...
#SBATCH -J closed_k2b-tsf-dann_cop-1layer
#SBATCH -p batch
#SBATCH --gres=gpu:4
...
source slurm/cdar/03_simnreal/021_closed_k400_babel/02_timesformer/022_dann_cop/_vars.sh
add_on='h100m'
extra_setting='1layer'  # 'default' if none
