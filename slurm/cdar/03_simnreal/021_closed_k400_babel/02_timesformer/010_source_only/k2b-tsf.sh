...
add_on='default'
extra_setting='norandaug'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/021_closed_k400_babel/02_timesformer/010_source_only/k2b_tsf.py'
