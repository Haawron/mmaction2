...
add_on='default'
extra_setting='no_jitter'  # 'default' if none
...
config='configs/recognition/cdar/03_simnreal/011_closed_babel_k400/01_tsm/01_source_only/b2k_tsm.py'
