...
#SBATCH -J vosuda-tsm-dann-l2g1_dc1
#SBATCH -p batch_vll
#SBATCH --gres=gpu:8
...
config='configs/recognition/cdar/03_simnreal/022_vosuda_k400_babel/01_tsm/020_dann/temporal_locality/k2b_tsm_dann_lngn_dc1.py'
ckpts=(
