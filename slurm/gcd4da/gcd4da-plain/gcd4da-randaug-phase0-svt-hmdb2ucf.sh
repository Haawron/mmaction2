...
#SBATCH -J gcd4da-randaug-phase0-svt-hmdb2ucf
#SBATCH --gres=gpu:4
#SBATCH -t 8:00:00
#SBATCH -p batch
#SBATCH --array 0-9%2
...
config=configs/recognition/hello/gcd4da/plain/gcd4da_randaug_phase0_svt_hmdb2ucf.py
workdir=work_dirs/train_output/hmdb2ucf/svt/gcd4da/plain/phase0/randaug/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
