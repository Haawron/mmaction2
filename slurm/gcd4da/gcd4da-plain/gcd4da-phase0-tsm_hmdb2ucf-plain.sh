...
#SBATCH -J gcd4da-phase0-tsm_hmdb2ucf-plain
#SBATCH --gres=gpu:4
#SBATCH -t 4-0
#SBATCH -p batch
#SBATCH --array 0-5%2
...
workdir=work_dirs/train_output/hmdb2ucf/tsm/gcd4da/plain/phase0/one_way/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
