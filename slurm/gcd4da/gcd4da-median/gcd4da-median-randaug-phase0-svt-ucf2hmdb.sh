...
#SBATCH -J gcd4da-median-randaug-phase0-svt-ucf2hmdb
#SBATCH --gres=gpu:4
#SBATCH -t 8:00:00
#SBATCH -p batch
#SBATCH --array 0-9%2
...
workdir=work_dirs/train_output/ucf2hmdb/svt/gcd4da/median/phase0/randaug/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
