...
#SBATCH -J gcd4da-median-phase0-tsm_ucf2hmdb
#SBATCH --gres=gpu:4
#SBATCH -t 4-0
#SBATCH -p batch
...
config=configs/recognition/hello/gcd4da/median/gcd4da_median_phase0_tsm_ucf2hmdb.py
workdir=work_dirs/train_output/ucf2hmdb/tsm/gcd4da/median/phase0/randomalpha/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
...
OMP_NUM_THREADS=${N} MKL_NUM_THREADS=${N} torchrun --nproc_per_node=${N} --master_port=$((10000+$RANDOM%20000)) tools/train.py $config \
    ...
    --cfg-options \
        ...
        model.cls_head.loss_cls.loss_ratio=$lambda \
