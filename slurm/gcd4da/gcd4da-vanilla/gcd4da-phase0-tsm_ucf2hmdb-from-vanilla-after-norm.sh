...
#SBATCH -J gcd4da-phase0-tsm_ucf2hmdb-from-vanilla-after-norm
#SBATCH --gres=gpu:4
#SBATCH -t 4-0
#SBATCH -p batch
#SBATCH --array 0-35%2
...
workdir=work_dirs/train_output/ucf2hmdb/tsm/gcd4da/vanilla/phase0/default/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
