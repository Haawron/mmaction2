...
#SBATCH -J GCD4DA_tsm_ek100_sanity_three_way_no_source
#SBATCH --gres=gpu:4
#SBATCH -t 4-0
#SBATCH --array 0-1%1
#SBATCH -p vll
...
python -m torch.distributed.launch --nproc_per_node=4 --master_port=$((10000+$RANDOM%20000)) tools/train.py configs/recognition/hello/ours/gcd4da_phase0_tsm_ek100.py --launcher pytorch \
    --work-dir work_dirs/sanity/ek100/tsm/GCD4DA/3_way/${task}/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time} \
    --cfg-options \
