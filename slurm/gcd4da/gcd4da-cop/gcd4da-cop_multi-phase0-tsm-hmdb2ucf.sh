...
#SBATCH -J gcd4da-cop_multi-phase0-tsm-hmdb2ucf
#SBATCH --gres=gpu:4
#SBATCH -t 4-0
#SBATCH -p batch
#SBATCH --array 0-17%2
...
workdir=work_dirs/train_output/hmdb2ucf/tsm/gcd4da/cop_multi/phase0/default/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
