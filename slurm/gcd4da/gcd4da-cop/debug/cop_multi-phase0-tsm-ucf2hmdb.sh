...
#SBATCH -J debug-cop_multi-phase0-tsm-ucf2hmdb
#SBATCH --gres=gpu:4
#SBATCH -t 4-0
#SBATCH -p batch
#SBATCH --array 0-17%2
...
workdir=work_dirs/train_output/ucf2hmdb/tsm/gcd4da/debug__cop_multi/phase0/default/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
...
OMP_NUM_THREADS=${N} MKL_NUM_THREADS=${N} torchrun --nproc_per_node=${N} --master_port=$((10000+$RANDOM%20000)) tools/train.py $config \
    ...
    --cfg-options \
        ...
        data.train.1.ann_file=data/_filelists/hmdb51/filelist_hmdb_train_closed.txt \
        data.val.ann_file=data/_filelists/hmdb51/filelist_hmdb_val_closed.txt \
        data.test.ann_file=data/_filelists/hmdb51/filelist_hmdb_test_closed.txt \
