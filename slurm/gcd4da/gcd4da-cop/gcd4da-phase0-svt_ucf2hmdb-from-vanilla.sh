...
#SBATCH -J gcd4da-phase0-svt_ucf2hmdb-from-vanilla
#SBATCH --gres=gpu:4
#SBATCH -t 6:00:00
#SBATCH -p batch
#SBATCH --array 0-5%2
...
workdir=work_dirs/train_output/ucf2hmdb/svt/gcd4da/vanilla/phase0/one_way/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
