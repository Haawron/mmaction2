...
#SBATCH -J tsm-cop-hmdb2ucf-from-k400
#SBATCH -p batch
#SBATCH --gres=gpu:4
...
workdir=work_dirs/train_output/hmdb2ucf/tsm/cop-from-k400/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
