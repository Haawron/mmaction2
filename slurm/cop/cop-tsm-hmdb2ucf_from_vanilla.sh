...
ckpt=work_dirs/train_output/hmdb2ucf/tsm/vanilla/source-only/3514__tsm-hmdb-vanilla-source-only/1/20220722-023128/best_mean_class_accuracy_epoch_20.pth  # k400 pretrained
