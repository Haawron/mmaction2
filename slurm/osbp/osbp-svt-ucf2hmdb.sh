...
config=configs/recognition/hello/osbp/osbp_svt_ucf2hmdb.py
workdir=work_dirs/train_output/ucf2hmdb/svt/osbp/default/${SLURM_ARRAY_JOB_ID}__${SLURM_JOB_NAME}/${SLURM_ARRAY_TASK_ID}/${current_time}
