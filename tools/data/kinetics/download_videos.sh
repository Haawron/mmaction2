...
source /data/hyogun/anaconda3/etc/profile.d/conda.sh
...
DATA_DIR="/data2/local_datasets/${DATASET}"
ANNO_DIR="./${DATASET}/annotations"
python download.py ${ANNO_DIR}/kinetics_train.csv ${DATA_DIR}/videos_train -n 2048
python download.py ${ANNO_DIR}/kinetics_val.csv ${DATA_DIR}/videos_val -n 2048
